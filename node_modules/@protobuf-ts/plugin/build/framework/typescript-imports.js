...
class TypeScriptImports {
    ...
    typeByName(source, typeName, kind = 'default', isTypeOnly = false) {
        const descType = this.registry.get(typeName);
        runtime_1.assert((descType === null || descType === void 0 ? void 0 : descType.kind) == "message" || (descType === null || descType === void 0 ? void 0 : descType.kind) === "enum" || (descType === null || descType === void 0 ? void 0 : descType.kind) == "service");
