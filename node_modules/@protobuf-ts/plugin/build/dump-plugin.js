...
`;
class DumpPlugin extends plugin_base_1.PluginBaseProtobufES {
    constructor() {
        super(...arguments);
    ...
    generate(request) {
        ...
        if (parameter === null || parameter === void 0 ? void 0 : parameter.endsWith(JSON_SUFFIX)) {
            ...
            fs_1.writeFileSync(parameter, protobuf_1.toJsonString(wkt_1.CodeGeneratorRequestSchema, request, { prettySpaces: 2 }));
        }
        else if (parameter === null || parameter === void 0 ? void 0 : parameter.endsWith(BIN_SUFFIX)) {
            DumpPlugin.mkdir(parameter);
            let bytes = protobuf_1.toBinary(wkt_1.CodeGeneratorRequestSchema, request);
            fs_1.writeFileSync(parameter, bytes);
            try {
                protobuf_1.fromBinary(wkt_1.CodeGeneratorRequestSchema, bytes);
            }
            catch (e) {
