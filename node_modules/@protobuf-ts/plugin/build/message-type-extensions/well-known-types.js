...
const typescript_method_from_text_1 = require("../framework/typescript-method-from-text");
...
class WellKnownTypes {
    ...
    make(source, descMessage) {
        const fn = this[descMessage.typeName];
        if (fn) {
            let r = fn.apply(this, [source, descMessage]);
            if (typeof r == "string") {
                return [typescript_method_from_text_1.typescriptMethodFromText(r)];
            }
            if (Array.isArray(r)) {
                return r.map(txt => typescript_method_from_text_1.typescriptMethodFromText(txt));
            }
        }
        return [];
    }
    ...
    ['google.protobuf.Timestamp'](source, descMessage) {
        const Timestamp = this.imports.type(source, descMessage), PbLong = this.imports.name(source, 'PbLong', this.options.runtimeImportPath), JsonWriteOptions = this.imports.name(source, 'JsonWriteOptions', this.options.runtimeImportPath, true), JsonReadOptions = this.imports.name(source, 'JsonReadOptions', this.options.runtimeImportPath, true), JsonValue = this.imports.name(source, 'JsonValue', this.options.runtimeImportPath, true), typeofJsonValue = this.imports.name(source, 'typeofJsonValue', this.options.runtimeImportPath);
    ...
    ['google.protobuf.Duration'](source, descMessage) {
    ...
    ['google.protobuf.FieldMask'](source, descMessage) {
        const FieldMask = this.imports.type(source, descMessage), JsonWriteOptions = this.imports.name(source, 'JsonWriteOptions', this.options.runtimeImportPath, true), JsonReadOptions = this.imports.name(source, 'JsonReadOptions', this.options.runtimeImportPath, true), lowerCamelCase = this.imports.name(source, 'lowerCamelCase', this.options.runtimeImportPath), JsonValue = this.imports.name(source, 'JsonValue', this.options.runtimeImportPath, true), typeofJsonValue = this.imports.name(source, 'typeofJsonValue', this.options.runtimeImportPath);
        return [
            `
            /**
    ...
    ['google.protobuf.Struct'](source, descMessage) {
        const Struct = this.imports.type(source, descMessage), JsonObject = this.imports.name(source, 'JsonObject', this.options.runtimeImportPath, true), JsonWriteOptions = this.imports.name(source, 'JsonWriteOptions', this.options.runtimeImportPath, true), JsonReadOptions = this.imports.name(source, 'JsonReadOptions', this.options.runtimeImportPath, true), JsonValue = this.imports.name(source, 'JsonValue', this.options.runtimeImportPath, true), typeofJsonValue = this.imports.name(source, 'typeofJsonValue', this.options.runtimeImportPath), isJsonObject = this.imports.name(source, 'isJsonObject', this.options.runtimeImportPath);
        return [
            `
            /**
             * Encode \`${descMessage.name}\` to JSON object. 
    ...
    ['google.protobuf.Value'](source, descMessage) {
        const Value = this.imports.type(source, descMessage), JsonWriteOptions = this.imports.name(source, 'JsonWriteOptions', this.options.runtimeImportPath, true), JsonReadOptions = this.imports.name(source, 'JsonReadOptions', this.options.runtimeImportPath, true), JsonValue = this.imports.name(source, 'JsonValue', this.options.runtimeImportPath, true), typeofJsonValue = this.imports.name(source, 'typeofJsonValue', this.options.runtimeImportPath), nullValueField = field_info_generator_1.FieldInfoGenerator.createTypescriptLocalName('null_value', this.options), boolValueField = field_info_generator_1.FieldInfoGenerator.createTypescriptLocalName('bool_value', this.options), numberValueField = field_info_generator_1.FieldInfoGenerator.createTypescriptLocalName('number_value', this.options), stringValueField = field_info_generator_1.FieldInfoGenerator.createTypescriptLocalName('string_value', this.options), listValueField = field_info_generator_1.FieldInfoGenerator.createTypescriptLocalName('list_value', this.options), structValueField = field_info_generator_1.FieldInfoGenerator.createTypescriptLocalName('struct_value', this.options);
        return [
            `
            /**
    ...
    ['google.protobuf.ListValue'](source, descMessage) {
        const ListValue = this.imports.type(source, descMessage), JsonWriteOptions = this.imports.name(source, 'JsonWriteOptions', this.options.runtimeImportPath, true), JsonReadOptions = this.imports.name(source, 'JsonReadOptions', this.options.runtimeImportPath, true), JsonValue = this.imports.name(source, 'JsonValue', this.options.runtimeImportPath, true), typeofJsonValue = this.imports.name(source, 'typeofJsonValue', this.options.runtimeImportPath);
        return [
            `
            /**
    ...
    ['google.protobuf.BoolValue'](source, descMessage) {
        const BoolValue = this.imports.type(source, descMessage), JsonWriteOptions = this.imports.name(source, 'JsonWriteOptions', this.options.runtimeImportPath, true), JsonReadOptions = this.imports.name(source, 'JsonReadOptions', this.options.runtimeImportPath, true), JsonValue = this.imports.name(source, 'JsonValue', this.options.runtimeImportPath, true);
        return [
            `
            /**
            ...
            function internalJsonRead(json: ${JsonValue}, options: ${JsonReadOptions}, target?: ${BoolValue}): ${BoolValue} {
                if (!target) 
                    target = this.create();
                target.value = this.refJsonReader.scalar(json, ${wkt_1.FieldDescriptorProto_Type.BOOL}, undefined, "value") as boolean;
                return target;
            }
            `,
        ];
    }
    ['google.protobuf.StringValue'](source, descMessage) {
        ...
        return [
            ...
            function internalJsonRead(json: ${JsonValue}, options: ${JsonReadOptions}, target?: ${StringValue}): ${StringValue} {
                if (!target) 
                    target = this.create();
                target.value = this.refJsonReader.scalar(json, ${wkt_1.FieldDescriptorProto_Type.STRING}, undefined, "value") as string;
                return target;
            }
            `,
        ];
    }
    ['google.protobuf.DoubleValue'](source, descMessage) {
        ...
        return [
            ...
            function internalJsonWrite(message: ${DoubleValue}, options: ${JsonWriteOptions}): ${JsonValue} {
                return this.refJsonWriter.scalar(${wkt_1.FieldDescriptorProto_Type.FLOAT}, message.value, "value", false, true);
            }
            `, `
            /**
            ...
            function internalJsonRead(json: ${JsonValue}, options: ${JsonReadOptions}, target?: ${DoubleValue}): ${DoubleValue} {
                if (!target) 
                    target = this.create();
                target.value = this.refJsonReader.scalar(json, ${wkt_1.FieldDescriptorProto_Type.DOUBLE}, undefined, "value") as number;
                return target;
            }
            `,
        ];
    }
    ['google.protobuf.FloatValue'](source, descMessage) {
        ...
        return [
            ...
            function internalJsonWrite(message: ${FloatValue}, options: ${JsonWriteOptions}): ${JsonValue} {
                return this.refJsonWriter.scalar(${wkt_1.FieldDescriptorProto_Type.DOUBLE}, message.value, "value", false, true);
            }
            `, `
            /**
             * Decode \`${descMessage.name}\` from JSON number.
    ...
    ['google.protobuf.Int32Value'](source, descMessage) {
        ...
        return [
            ...
            function internalJsonWrite(message: ${Int32Value}, options: ${JsonWriteOptions}): ${JsonValue} {
                return this.refJsonWriter.scalar(${wkt_1.FieldDescriptorProto_Type.INT32}, message.value, "value", false, true);
            }
            `, `
            /**
             * Decode \`${descMessage.name}\` from JSON string.
            ...
            function internalJsonRead(json: ${JsonValue}, options: ${JsonReadOptions}, target?: ${Int32Value}): ${Int32Value} {
                if (!target) 
                    target = this.create();
                target.value = this.refJsonReader.scalar(json, ${wkt_1.FieldDescriptorProto_Type.INT32}, undefined, "value") as number;
                return target;
            }
            `,
        ];
    }
    ['google.protobuf.UInt32Value'](source, descMessage) {
        ...
        return [
            ...
            function internalJsonWrite(message: ${UInt32Value}, options: ${JsonWriteOptions}): ${JsonValue} {
                return this.refJsonWriter.scalar(${wkt_1.FieldDescriptorProto_Type.UINT32}, message.value, "value", false, true);
            }
            `, `
            /**
             * Decode \`${descMessage.name}\` from JSON string.
            ...
            function internalJsonRead(json: ${JsonValue}, options: ${JsonReadOptions}, target?: ${UInt32Value}): ${UInt32Value} {
                if (!target) 
                    target = this.create();
                target.value = this.refJsonReader.scalar(json, ${wkt_1.FieldDescriptorProto_Type.UINT32}, undefined, "value") as number;
                return target;
            }
            `,
        ];
    }
    ['google.protobuf.Int64Value'](source, descMessage) {
        const Int64Value = this.imports.type(source, descMessage), iLongType = this.imports.name(source, 'LongType', this.options.runtimeImportPath), JsonWriteOptions = this.imports.name(source, 'JsonWriteOptions', this.options.runtimeImportPath, true), JsonReadOptions = this.imports.name(source, 'JsonReadOptions', this.options.runtimeImportPath, true), JsonValue = this.imports.name(source, 'JsonValue', this.options.runtimeImportPath, true), ScalarType = this.imports.name(source, 'ScalarType', this.options.runtimeImportPath);
    ...
    ['google.protobuf.UInt64Value'](source, descMessage) {
    ...
    ['google.protobuf.BytesValue'](source, descMessage) {
        ...
        return [
            ...
            function internalJsonWrite(message: ${BytesValue}, options: ${JsonWriteOptions}): ${JsonValue} {
                return this.refJsonWriter.scalar(${wkt_1.FieldDescriptorProto_Type.BYTES}, message.value, "value", false, true);
            }
            `, `
            /**
             * Decode \`${descMessage.name}\` from JSON string.
            ...
            function internalJsonRead(json: ${JsonValue}, options: ${JsonReadOptions}, target?: ${BytesValue}): ${BytesValue} {
                if (!target) 
                    target = this.create();
                target.value = this.refJsonReader.scalar(json, ${wkt_1.FieldDescriptorProto_Type.BYTES}, undefined, "value") as Uint8Array;
                return target;
            }
            `,
        ];
