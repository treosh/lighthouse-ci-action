...
class ServiceClientGeneratorBase {
    ...
    generateInterface(source, descService) {
        const interpreterType = this.interpreter.getServiceType(descService), IServiceClient = this.imports.type(source, descService, this.symbolKindInterface), signatures = [];
     ...
     *
     */
    generateImplementationClass(source, descService) {
        const interpreterType = this.interpreter.getServiceType(descService), ServiceType = this.imports.type(source, descService), ServiceClient = this.imports.type(source, descService, this.symbolKindImplementation), IServiceClient = this.imports.type(source, descService, this.symbolKindInterface), ServiceInfo = this.imports.name(source, 'ServiceInfo', this.options.runtimeRpcImportPath, true), RpcTransport = this.imports.name(source, 'RpcTransport', this.options.runtimeRpcImportPath, true);
    ...
    makeI(source, methodInfo, isTypeOnly = false) {
        return ts.createTypeReferenceNode(ts.createIdentifier(this.imports.typeByName(source, methodInfo.I.typeName, 'default', isTypeOnly)), undefined);
    }
    makeO(source, methodInfo, isTypeOnly = false) {
        return ts.createTypeReferenceNode(ts.createIdentifier(this.imports.typeByName(source, methodInfo.O.typeName, 'default', isTypeOnly)), undefined);
    }
}
