...
describe('getEntity', () => {
  it('works for direct domain usage', () => {
    expect(getEntity('https://js.connect.facebook.net/lib.js')).toMatchInlineSnapshot(`
      Object {
        "averageExecutionTime": 408.4690048999128,
        "categories": Array [
          "social",
        ],
        "category": "social",
        ...
        "totalExecutionTime": 2352323166,
        "totalOccurrences": 5758878,
      }
    `)
  })
  ...
  it('works for inferred domain usage', () => {
    expect(getEntity('https://unknown.typekit.net/fonts.css')).toMatchInlineSnapshot(`
      Object {
        "averageExecutionTime": 656.4004391872108,
        "categories": Array [
          "cdn",
        ],
        "category": "cdn",
        ...
        "name": "Adobe TypeKit",
        "products": Array [],
        "totalExecutionTime": 112093503,
        "totalOccurrences": 170770,
      }
    `)
  })
