...
describe('getEntity', () => {
  it('works for direct domain usage', () => {
    expect(getEntity('https://js.connect.facebook.net/lib.js')).toMatchInlineSnapshot(`
      Object {
        "averageExecutionTime": 365.4461996146683,
        "categories": Array [
          "social",
        ],
        "category": "social",
        ...
        "totalExecutionTime": 1094635985,
        "totalOccurrences": 2995341,
      }
    `)
  })
  ...
  it('works for inferred domain usage', () => {
    expect(getEntity('https://unknown.typekit.net/fonts.css')).toMatchInlineSnapshot(`
      Object {
        "averageExecutionTime": 687.9917229405768,
        "categories": Array [
          "cdn",
        ],
        "category": "cdn",
        ...
        "name": "Adobe TypeKit",
        "products": Array [],
        "totalExecutionTime": 68158652,
        "totalOccurrences": 99069,
      }
    `)
  })
