...
const typescript_enum_builder_1 = require("../framework/typescript-enum-builder");
class EnumGenerator {
    ...
    registerSymbols(source, descEnum) {
        this.symbols.register(local_type_name_1.createLocalTypeName(descEnum), descEnum, source);
    }
    /**
    ...
    generateEnum(source, descriptor) {
        let enumObject = this.interpreter.getEnumInfo(descriptor)[1], builder = new typescript_enum_builder_1.TypescriptEnumBuilder();
